...
class HelloConfiguration(
    ...
    fun helloJob(): Job {
        ...
        return jobBuilderFactory.get("helloJob") // job 이름: helloJob /  'name'은 Spring Batch를 실행할 수 있는 Key이기도 하다.
...
//    @StepScope
    ...
    fun helloStep(): Step { // Step: Job의 실행단위 하나의 Job은 1개 이상의 Step을 가질 수 있다.
        return stepBuilderFactory.get("helloStep") // step도 name 설정이 필요하다.
